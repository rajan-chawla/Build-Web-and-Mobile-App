          ...
          <tbody>
            {data.map((rowData, index) => (
              <tr key={index}>
                ...
                <th> <button class="btn btn-success" onClick={(e) => approveProduct(rowData.id, e)}>Approve</button></th>
                <th><button class="btn btn-danger" onClick={(e) => rejectProduct(rowData.id, e)}>Reject</button></th>
              </tr>
            ))}
          </tbody>
        </table>
